...
//
// These mirror the Anthropic Messages API wire format for the /v1/messages endpoint.
// Used both for native passthrough (Anthropic, xAI) and for translation
// to/from internal OpenAI format (OpenAI, Google, Groq, Cerebras).
