...
export const TIERS: Record<string, TierConfig> = {
  economy: {
    models: [
      ...
      { provider: 'google',    model: 'gemini-2.5-flash',          quality: 0.70, inputPer1M: 0.30,  outputPer1M: 2.50,  latencyMs: 280,  maxContextTokens: 1_048_576 },
  ...
  standard: {
    models: [
      { provider: 'google',    model: 'gemini-2.5-pro',   quality: 0.88, inputPer1M: 1.25,  outputPer1M: 10.00, latencyMs: 600,  maxContextTokens: 1_048_576 },
