...
export const TIERS = {
    economy: {
        models: [
            ...
            { provider: 'google', model: 'gemini-3-flash-preview', quality: 0.72, inputPer1M: 0.50, outputPer1M: 3.00, latencyMs: 300, maxContextTokens: 1_048_576, priceSource: 'litellm' },
            ...
            { provider: 'openai', model: 'gpt-5.6-luna', quality: 0.62, inputPer1M: 0.20, outputPer1M: 1.20, latencyMs: 300, maxContextTokens: 1_050_000, priceSource: 'litellm' },
            ...
            { provider: 'grok', model: 'grok-4-1-fast', quality: 0.55, inputPer1M: 0.20, outputPer1M: 0.50, latencyMs: 180, maxContextTokens: 2_000_000, priceSource: 'litellm' },
            ...
            { provider: 'bedrock', model: 'zai.glm-4.7-flash', quality: 0.51, inputPer1M: 0.070, outputPer1M: 0.400, latencyMs: 350, maxContextTokens: 202_752, priceSource: 'litellm' },
            ...
            // Gemma 4 open models (Bedrock Mantle) — tiny and ultra-cheap; great for classification/extraction
            { provider: 'bedrock', model: 'google.gemma-4-e2b', quality: 0.38, inputPer1M: 0.04, outputPer1M: 0.08, latencyMs: 220, maxContextTokens: 128_000, priceSource: 'litellm' },
            { provider: 'bedrock', model: 'google.gemma-4-26b-a4b', quality: 0.52, inputPer1M: 0.13, outputPer1M: 0.40, latencyMs: 280, maxContextTokens: 256_000, priceSource: 'litellm' },
        ],
    ...
    standard: {
        models: [
            ...
            { provider: 'openai', model: 'gpt-5.3-chat-latest', quality: 0.88, inputPer1M: 1.75, outputPer1M: 14.00, latencyMs: 600, maxContextTokens: 1_047_576, priceSource: 'litellm' },
            { provider: 'openai', model: 'gpt-5.3-codex', quality: 0.91, inputPer1M: 1.75, outputPer1M: 14.00, latencyMs: 800, maxContextTokens: 400_000, apiType: 'responses', priceSource: 'litellm' },
            ...
            { provider: 'openai', model: 'gpt-5.6-terra', quality: 0.91, inputPer1M: 2.00, outputPer1M: 12.00, latencyMs: 650, maxContextTokens: 1_050_000, priceSource: 'litellm' },
            ...
            { provider: 'anthropic', model: 'claude-sonnet-5', quality: 0.92, inputPer1M: 2.00, outputPer1M: 10.00, latencyMs: 500, maxContextTokens: 1_000_000, priceSource: 'litellm' },
            ...
            { provider: 'grok', model: 'grok-4.3', quality: 0.78, inputPer1M: 1.25, outputPer1M: 2.50, latencyMs: 500, maxContextTokens: 1_000_000, priceSource: 'litellm' },
            { provider: 'grok', model: 'grok-4.5', quality: 0.86, inputPer1M: 2.00, outputPer1M: 6.00, latencyMs: 550, maxContextTokens: 500_000, priceSource: 'litellm' },
            // Bedrock standard models — manual: verify prices at https://aws.amazon.com/bedrock/pricing/ (US West Oregon)
            { provider: 'bedrock', model: 'zai.glm-4.7', quality: 0.90, inputPer1M: 0.60, outputPer1M: 2.20, latencyMs: 550, maxContextTokens: 202_752, priceSource: 'litellm', dedupKey: 'glm-4.7' },
            ...
            { provider: 'bedrock', model: 'mistral.devstral-2-123b', quality: 0.85, inputPer1M: 0.40, outputPer1M: 2.00, latencyMs: 600, maxContextTokens: 262_144, priceSource: 'litellm' },
            ...
            { provider: 'bedrock', model: 'nvidia.nemotron-super-3-120b', quality: 0.75, inputPer1M: 0.15, outputPer1M: 0.65, latencyMs: 500, maxContextTokens: 131_072, isThinkingModel: true, priceSource: 'litellm' },
        ],
        description: 'Balanced quality and cost. The default for most applications.',
    },
    premium: {
        models: [
            { provider: 'google', model: 'gemini-3.1-pro-preview', quality: 1.00, inputPer1M: 2.00, outputPer1M: 12.00, latencyMs: 900, maxContextTokens: 1_048_576, priceSource: 'litellm' },
            { provider: 'anthropic', model: 'claude-opus-4-7', quality: 0.99, inputPer1M: 5.00, outputPer1M: 25.00, latencyMs: 1200, maxContextTokens: 1_000_000, priceSource: 'litellm' },
            ...
            { provider: 'anthropic', model: 'claude-opus-5', quality: 1.00, inputPer1M: 5.00, outputPer1M: 25.00, latencyMs: 1100, maxContextTokens: 1_000_000, priceSource: 'litellm' },
            { provider: 'anthropic', model: 'claude-fable-5', quality: 1.00, inputPer1M: 10.00, outputPer1M: 50.00, latencyMs: 1500, maxContextTokens: 1_000_000, priceSource: 'litellm' },
            ...
            { provider: 'openai', model: 'gpt-5.6-sol', quality: 0.99, inputPer1M: 5.00, outputPer1M: 30.00, latencyMs: 950, maxContextTokens: 1_050_000, priceSource: 'litellm' },
            { provider: 'openai', model: 'gpt-5.4', quality: 0.96, inputPer1M: 2.50, outputPer1M: 15.00, latencyMs: 900, maxContextTokens: 1_050_000, priceSource: 'litellm' },
            { provider: 'bedrock', model: 'zai.glm-5', quality: 0.93, inputPer1M: 1.00, outputPer1M: 3.20, latencyMs: 650, maxContextTokens: 200_000, priceSource: 'litellm' },
        ],
...
export const MODEL_ALIASES = {
    ...
    'gpt-5.4': 'premium',
    'gpt-5.5': 'premium',
    'gpt-5.6': 'premium', // flagship alias → gpt-5.6-sol
    'gpt-5.6-sol': 'premium',
    ...
    'grok-4.3': 'standard',
    'grok-4.5': 'standard',
    'grok-4-1-fast': 'economy',
    // Gemma aliases (Google open models via Bedrock Mantle)
    'gemma': 'economy',
    'gemma-4': 'economy',
    'gemma-4-e2b': 'economy',
    'gemma-4-26b': 'economy',
