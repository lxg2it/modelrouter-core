...
const VERTEX_BASE_URL_TEMPLATE = 'https://aiplatform.googleapis.com/v1/projects/{PROJECT_ID}/locations/global/endpoints/openapi';
...
export class VertexAdapter {
    ...
    projectId = null;
    cachedToken = null;
    constructor(serviceAccountJsonPath, projectId) {
    ...
    async getAccessToken() {
        if (!this.auth)
            throw new Error('Vertex adapter not configured');
        const now = Date.now();
