...
export function createApp() {
    ...
    const keyUserCache = new Map();
    const resolveUserId = (keyId) => {
  ...
  `);
    ...
    //
    const sessionAuth = sessionMiddleware(userStore, process.env.RISK_SCORING_DISABLED === '1' ? undefined : riskScorer);
